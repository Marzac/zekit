...
\begin{tcolorbox}
    \textcolor{red}{
        \textbf{All connectors are located on the bottom side of the PCB and must be soldered from the top.}
    }
\end{tcolorbox}
...
This trimmer is labeled (Todo: labeling). Do not confuse it with the 10k variant.

\subsubsection{10k trimmer}

This trimmer is labeled (Todo: labeling). Do not confuse it with the 1k variant.
...
These 2 pots are labeled \textbf{10 B3} on the bottom. Do not confuse them with the 100k variants.

\subsubsection{100k potentiometers}

These 4 pots are labeled \textbf{10 B4} on the bottom. Do not confuse them with the 10k variants.

\subsubsection{Connectors}

The connectors are soldered last because they are located on the bottom side of the PCB.
