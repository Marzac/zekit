...
This circuit is used to convert the linear filter control voltage into an exponential curve for setting the cutoff frequency. The requirement for this is the nature of our human hearing which recognizes pitches in an exponential way.
