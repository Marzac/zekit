...
The 10k pots are labeled \textbf{B103} at their bottom whereas the 100k pots are labeled \textbf{B104}.
Make sure to install the right value at the right spot, by \textbf{following the markings} drawn on the PCB silk screen print.
Also, keep your attention on soldering the pots straight.

\pagebreak
\subsubsection{Step 7: Connectors, Power Switch \& Power LED}
...
The \textbf{connectors, power switch and power LED} are soldered last because they are located at the bottom side of the PCB.
If the trimmer was not installed at step 3, it is the moment to solder it too.
...
\pagebreak
\subsubsection{Step 8: Installing the ICs}
